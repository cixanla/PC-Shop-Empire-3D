...
- Issue #62 tek canonical EPS12V/CPU 8-pin güç kablosunun deterministic authored route/unroute akışı için parent #10 altında açıldı ve Roadmap'te `In Progress` yapıldı. ATX24 identity/receipt/container state'i, electrical power-on, completed benchmark ve genel Inventory refactoru kapsam dışıdır.
