...
| Issue #66 teknik + yerel checkpoint'i | Core feature `f9545605baff423f05615e7326902e24dc82aeeb`, technical source `f8afd62326c74aff23fa10bb33ef79ecb9a656b6`, source/docs `4e1ef4322d9ef049e3aac915c611474f6bee92fd`, tree `4df76fb1b50da53bdee7e65cb64acf0e73a5c018`; exact quote/reservation setinden immutable BuildOrder + WorkTicket, exactly-once allocation receipt ve canonical workbench physical ticket. Guard `32721069982` + `32723213686`, draft PR #67; Mac+Windows full test/build/native r34 geçti. Yerel milestone `906/906`, `896/896`, `9/9`, `17.330.935` bayt ve `1514481a…4121` manifest ile doğrulandı. Fiziksel USB/final metadata bekliyor, Issue/Roadmap açık/In Progress |
...
1. Doğrulanmış source/docs `4e1ef4322d9ef049e3aac915c611474f6bee92fd` + Guard `32723213686` ve `906/906` yerel immutable Issue #66 milestone'unu koru; bu katmanları technical source `f8afd62` kanıtından ve fiziksel USB kapanışından ayrı tut.
2. Kullanıcı doğru USB'nin bağlandığını açıkça bildirdiğinde önce external physical disk, exact `/Volumes/cixanla/CIXANLA`, `90_BACKUPS/PCShopEmpire3D` ve önceki milestone zincirini salt-okunur doğrula. Yalnız collision-free `.incoming-*` hedefte ilk tam readback, atomik final adlandırma ve ikinci tam readback sonrasında metadata/Guard/acceptance `18/18`/Issue/Roadmap/PR kapanışını tamamla.
3. Sonraki bounded oyuncu-görünür paket olarak work order'a ayrılmış exact motherboard'ı gerçek pickup/carry/placement akışıyla dedicated build-kit slotuna taşı ve fiziksel `0/10 → 1/10` ilerlemeyi göster; sonra diğer kit parçaları, montaj, power-on/POST, OS/driver, benchmark/QA, paketleme/teslimat ve final settlement zincirini bağımlılık sırasıyla ilerlet. Mevcut graybox'ı final art sayma ve Guardian'ı gameplay authority yapma.
