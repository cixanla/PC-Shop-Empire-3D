...
1. Issue #81 fiziksel metadata commit/Guard ve acceptance `24/24` Issue/Project/PR idari zincirini tamamla; technical head, source/docs checkpoint'i veya eski immutable paketlerin üzerine yazma.
