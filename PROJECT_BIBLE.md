...
| 2 | Temel mağaza döngüsü | Devam ediyor; Catalog/Inventory, purchase-order receiving, fiziksel teslimat/raf, offer, customer basket reservation ve immutable checkout price snapshot tamam; atomik satış commit'i sırada |
...
1. [Issue #8](https://github.com/cixanla/PC-Shop-Empire-3D/issues/8) altında exact checkout reservation'ını atomik tüketen ve serialized item için tek satış/fulfilled sonucu üreten bounded commit sözleşmesini kur.
...
5. Edit Mode 233/233 ve Play Mode 17/17 baseline testlerini doğrula.
