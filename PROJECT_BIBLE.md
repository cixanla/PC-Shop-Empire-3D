...
| Güncel USB milestone | `2026-08-15_STAGE_B_AUTHORITATIVE_STOCK_FLOW`; 467 tracked kaynak + 4 test/build/runtime kanıtı + source kaydı, 472 satırlı `5521f869…22a3` SHA-256 manifest/readback ve source checksum ile doğrulandı; cache/build/credential/AppleDouble dışarıda |
