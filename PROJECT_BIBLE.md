...
## Güncel geliştirme checkpoint'i — Issue #61

Epic #10'un tek ATX24 split-PSU kablo routing dilimi feature `1fc29f13171925c2445eaa7334158e0f058e76a5` ile tamamlandı. Tek canonical serialized kablo; typed PSU 18-pin + PSU 10-pin + motherboard 24-pin endpoint'leri, üç stable ordered waypoint'i ve capacity-one CableRoute'u atomik sekiz-container Inventory claim'i içinde kullanır. Oyuncu gerçek keyboard/mouse veya gamepad ile aynı fiziksel kabloyu alır, keyed route preview'ını açar, görünür beş-segment güzergâhı bağlar ve motherboard connector üzerinden exact source lineage ile yeniden eline alır. Generic placement/stack/cart/raw-transfer bypass'ları ve host detach işlemleri routed durumda fail-closed'dur; same-instance identity/recovery korunur. GarageGraybox r30, EditMode `589/589`, PlayMode `49/49`, Universal macOS `329082160` bayt ve aktif Apple M1/Metal 1280×720 exact cable smoke ile doğrulandı. Feature tree `d265332f1d6655639e55db31f9b5a11e3d177f49`; [feature Repository Guard 32613813494](https://github.com/cixanla/PC-Shop-Empire-3D/actions/runs/32613813494) başarılıdır. Source/docs `52795b66fee1eb933d0d9c4ff8cbd7eca512d718`, tree `d0bdb7bd39bb09a27565ed1d4a0fd77e22b7dfa3` ve [Guard 32614187494](https://github.com/cixanla/PC-Shop-Empire-3D/actions/runs/32614187494) ile private `main`e ulaştı. Ayrı USB milestone'u 801/801 iki tam hash/boyut/yol readback, 796/796 exact Git source, 4/4 evidence ve sıfır güvenlik/AppleDouble farkıyla doğrulandı. Acceptance `20/20` ile Issue/Project kapanış metadata'sı bu checkpoint'in kalan son kapısıdır; doğrulanmadan tamamlandı sayılmaz.
...
| Issue #61 kapanış checkpoint'i | Feature `1fc29f13171925c2445eaa7334158e0f058e76a5`, tree `d265332f1d6655639e55db31f9b5a11e3d177f49`; source/docs `52795b66fee1eb933d0d9c4ff8cbd7eca512d718`, tree `d0bdb7bd39bb09a27565ed1d4a0fd77e22b7dfa3`; [feature Guard 32613813494](https://github.com/cixanla/PC-Shop-Empire-3D/actions/runs/32613813494) ve [source/docs Guard 32614187494](https://github.com/cixanla/PC-Shop-Empire-3D/actions/runs/32614187494) başarılı; ayrı USB milestone 801/801 ve 796/796 doğrulandı; acceptance `20/20` ile Issue/Project kapanışı bekliyor |
| Son test/build | Issue #61 sonrası Edit Mode `589/589` (`issue61-full-editmode-final.xml`), gerçek Input System Play Mode `49/49` (`issue61-full-playmode-final.xml`), failed/skipped/inconclusive `0`; Universal macOS build `329082160` bayt ve aktif Apple M1/Metal makinesinde 1280×720 `garage-atx24-power-cable-routing-r30-v1` readiness + exact cable smoke geçti; scene SHA-256 `79c534c7749a60521fae605f29c65db2d224d0fb75b444ea109a6f5c3b0040b2` |

Önceki zaman/olay Core commit'i `8af2ad3d05906839c4b607e4958650e723060465`, iş birliği/devir checkpoint'i `2ee421193833111f76c85dabb33910240c36db03` ve Issue #50–#60 checkpointleri tarihsel olarak korunur. Issue #61 kaynak/test/build/runtime doğrulaması `Docs/ProjectBible/10_DEVAM_CHECKPOINT.md`, ADR-0039 ve tarihli evidence belgesinde kayıtlıdır.

## 16. Sıradaki uygulama sırası

1. Issue #61 acceptance `20/20`, GitHub Project `Done`, Issue kapanışı ve final metadata Guard kapısını tamamla.
2. Ardıl Epic #10 child'ını yalnız EPS12V/CPU güç kablosu konektörleri ve fiziksel routing için sınırla; PCIe/SATA/fan/front-panel cabling, electrical power-on, POST/BIOS/OS ve tamamlanmış benchmarkı aynı pakete gizlice ekleme.
