...
{
    /// <summary>
    /// Canonical r32 visual contract for one PCIe GPU 8-pin 6+2 cable. The same
    ...
    public sealed class PcieGpuPowerCableRuntimeGeometry : MonoBehaviour
    {
        public const string RuntimeMarker = "r32.pcie-gpu-power-cable.geometry";

        [SerializeField] private Transform psu8Connector;
        [SerializeField] private Transform graphicsCard8Connector;
        ...
        [SerializeField] private Transform graphicsCardAnchor;
        ...
        private Vector3 _graphicsCardLoosePosition;
        private Quaternion _graphicsCardLooseRotation;
        ...
        public Transform GraphicsCard8Connector => graphicsCard8Connector;
            ...
            Transform[] authoredWaypoints)
        {
            ...
            graphicsCardAnchor = authoredGraphicsCardAnchor ??
                throw new ArgumentNullException(nameof(authoredGraphicsCardAnchor));
            ...
            {
                throw new ArgumentException(
                    "PCIe GPU geometry must preserve one physical item, two connectors and zero joints.");
            }
        ...
        private void RefreshGeometry()
        {
            ...
            if (IsRouted)
            {
                psu8Connector.SetPositionAndRotation(
                    psuAnchor.position,
                    psuAnchor.rotation);
                graphicsCard8Connector.SetPositionAndRotation(
                    graphicsCardAnchor.position,
                    graphicsCardAnchor.rotation);
                ...
                routedTrunk.SetPosition(4, graphicsCardAnchor.position);
                return;
            }
        ...
        private void CaptureLooseConnectorPoses()
        {
            ...
            _graphicsCardLoosePosition = graphicsCard8Connector.localPosition;
            _graphicsCardLooseRotation = graphicsCard8Connector.localRotation;
        }
        ...
        private void RestoreLooseConnectorPoses()
        {
            ...
            if (graphicsCard8Connector != null)
            {
                graphicsCard8Connector.localPosition = _graphicsCardLoosePosition;
                graphicsCard8Connector.localRotation =
                    _graphicsCardLooseRotation;
            }
        }
        ...
        private bool ValidateCanonicalConfiguration()
        {
            return IsOwnedChild(psu8Connector) &&
                   IsOwnedChild(graphicsCard8Connector) &&
                   psu8Connector != graphicsCard8Connector &&
                   looseCoil != null &&
                   routedTrunk != null &&
                   looseCoil != routedTrunk &&
                   psuAnchor != null &&
                   graphicsCardAnchor != null &&
                   waypoints != null &&
                   waypoints.Length == 3 &&
