...
namespace PCShopEmpire3D.Presentation
{
    public sealed partial class GaragePrototypeMarker : MonoBehaviour
    {
        ...
        public const string Version = "garage-post-startup-r62-v1";
        ...
        public MemoryModuleBuildKitProjection MemoryModuleBuildKit =>
        ...
        public bool HasMotherboardBuildKitR35Runtime =>
            motherboardBuildKit != null &&
            motherboardBuildKit.IsCanonical &&
            motherboardBinding != null &&
            motherboardBinding.MatchesBuildKitConfiguration(motherboardBuildKit) &&
            playerCarry != null &&
            playerCarry.MatchesMotherboardBuildKitConfiguration(
                motherboardBuildKit,
                motherboardBinding) &&
        ...
        public bool HasMemoryModuleBuildKitR37Runtime =>
            memoryModuleBuildKit != null &&
            memoryModuleBuildKit.IsCanonical &&
            memoryModuleBuildKit.Runtime == stockFlow &&
            dimmBinding != null &&
            dimmBinding.PhysicalItem == memoryModule &&
            dimmBinding.Slot == dimmSlot &&
            dimmBinding.MatchesBuildKitConfiguration(memoryModuleBuildKit) &&
            memoryModule != null &&
            dimmSlot != null &&
            playerCarry != null &&
            playerCarry.MatchesMemoryModuleBuildKitConfiguration(
                memoryModuleBuildKit,
                dimmBinding) &&
            FindObjectsByType<MemoryModuleBuildKitProjection>(
                FindObjectsSortMode.None).Length == 1;

        public bool HasStorageBuildKitR38Runtime =>
            storageBuildKit != null &&
            storageBuildKit.IsCanonical &&
            storageBuildKit.Runtime == stockFlow &&
            storageBinding != null &&
            storageBinding.PhysicalItem == storageDevice &&
            storageBinding.Slot == storageSlot &&
            storageBinding.MatchesBuildKitConfiguration(storageBuildKit) &&
            storageDevice != null &&
            storageSlot != null &&
            playerCarry != null &&
            playerCarry.MatchesStorageBuildKitConfiguration(
                storageBuildKit,
                storageBinding) &&
                ...
                physicalElectricalPowerTestStation = null)
        {
            ...
            ConfigureAtx24PowerCable(
                physicalAtx24PowerCableRoute,
        ...
        private void Start()
        {
            ...
            if (atx24PowerCableRoute != null &&
                processorCooler != null &&
                graphicsCard != null &&
                ResolveAtx24ChassisCablePassThroughRoot() is Transform
                    chassisCablePassThroughRoot)
            {
                atx24PowerCableRoute.ConfigureInstalledAssemblyHostRoots(
            ...
            bool hasAtx24PowerCableRoute = assemblySession != null &&
                                           atx24PowerCableRoute != null &&
                                           atx24PowerCableRoute.IsConfigured &&
                                           atx24PowerCableRoute.RouteIdValue ==
                                               GarageStockFlowSession
                                                   .Atx24PowerCableRouteIdValue &&
                                           atx24PowerCableRoute
                                                   .PsuPrimaryEndpointIdValue ==
                                               GarageStockFlowSession
                                                   .Atx24PowerCablePsuPrimaryEndpointIdValue &&
                                           atx24PowerCableRoute
                                                   .PsuSenseEndpointIdValue ==
                                               GarageStockFlowSession
            ...
            bool hasAtx24PowerCableIdentity = assemblySession != null &&
                                              atx24PowerCableBinding != null &&
                                              atx24PowerCable != null &&
                                              atx24PowerCableBinding.Runtime == stockFlow &&
                                              atx24PowerCableBinding.PhysicalItem ==
                                                  atx24PowerCable &&
                                              atx24PowerCableBinding
                                                      .InventoryItemIdValue ==
                                                  assemblySession
                                                      .Atx24PowerCableItemId.Value &&
                                              atx24PowerCable.ItemIdValue ==
                                                  assemblySession
                                                      .Atx24PowerCableItemId.Value &&
                                              assemblySession
                                                  .TryGetAtx24PowerCableItem(
                                                      out InventoryItemRecord cableItem) &&
                                              cableItem.Id ==
                                                  assemblySession.Atx24PowerCableItemId &&
                                              cableItem.ProductId ==
                                                  assemblySession.Atx24PowerCableProductId &&
                                              cableItem.ContainerId ==
                                                  assemblySession.WorldFloorContainerId &&
                                              CountCanonicalAtx24PowerCableProjections(
                                                  cableItem.Id.Value) == 1 &&
                                              atx24PowerCableBinding
                                                  .ValidateProjectionInvariant().IsSuccess;
            bool hasAtx24PowerCableAssembly = hasAtx24PowerCableRoute &&
                                              hasAtx24PowerCableIdentity &&
                                              atx24PowerCableBinding.Route ==
                                                  atx24PowerCableRoute &&
                                              playerCarry != null &&
                                              playerCarry
                                                  .MatchesAtx24PowerCableConfiguration(
                                                      atx24PowerCableRoute,
                                                      atx24PowerCableBinding) &&
                                              atx24PowerCable.CarryProfile ==
                                                  PhysicalCarryProfile.PcComponent &&
                                              assemblySession.AssemblyBuild
            ...
            bool runMemoryModuleBuildKitSmoke =
            ...
            if (requireWindowsD3D11)
            {
                        ...
                        SystemInfo.graphicsDeviceType))
                {
                    ...
                    else if (runPowerSupplyAssemblyHandoffSmoke)
                    {
                    ...
                    else if (runMemoryModuleBuildKitSmoke)
                    {
                        LogMemoryModuleBuildKitSmokeFailure(
                            "smoke.graphics-api-mismatch");
                    }
                    else if (runProcessorBuildKitSmoke)
                    {
            ...
            if (runAtx24PowerCableSmoke && !Debug.isDebugBuild)
            {
                Debug.LogError(
                    "GARAGE_ATX24_POWER_CABLE_RUNTIME_SMOKE " +
                    "cable-flow=failed code=smoke.power-cable-requires-development-build");
                return;
            }
            ...
            if (runMotherboardBuildKitSmoke && !Debug.isDebugBuild)
            {
                Debug.LogError(
                    "GARAGE_MOTHERBOARD_BUILD_KIT_RUNTIME_SMOKE " +
                    "build-kit-flow=failed " +
                    "code=smoke.motherboard-build-kit-requires-development-build");
                return;
            }
            ...
            if (runMemoryModuleBuildKitSmoke && !Debug.isDebugBuild)
            {
                Debug.LogError(
                    "GARAGE_MEMORY_MODULE_BUILD_KIT_RUNTIME_SMOKE " +
                    "build-kit-flow=failed " +
                    "code=smoke.memory-module-build-kit-requires-development-build");
                return;
            }

            if (runStorageBuildKitSmoke && !Debug.isDebugBuild)
            {
                Debug.LogError(
                    "GARAGE_STORAGE_BUILD_KIT_RUNTIME_SMOKE " +
                    "build-kit-flow=failed " +
                    "code=smoke.storage-build-kit-requires-development-build");
                return;
            }
            ...
            if (runAtx24PowerCableAssemblyHandoffSmoke && !Debug.isDebugBuild)
            {
                LogAtx24PowerCableAssemblyHandoffSmokeFailure(
                    "smoke.atx24-power-cable-assembly-handoff-" +
            ...
            if (runMemoryModuleBuildKitSmoke)
            {
                Application.runInBackground = true;
                StartCoroutine(RunMemoryModuleBuildKitSmoke());
            }
