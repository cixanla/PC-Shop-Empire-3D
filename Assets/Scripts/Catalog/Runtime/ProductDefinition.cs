...
namespace PCShopEmpire3D.Catalog
{
    ...
    public static class CatalogFailures
    {
        ...
        public static readonly Failure InvalidPowerSupplyType =
            Failure.FromCode("catalog.component.power-supply-type.invalid");
        public static readonly Failure InvalidPowerCableType =
            Failure.FromCode("catalog.component.power-cable-type.invalid");
