...
namespace PCShopEmpire3D.Editor.GaragePrototype
{
    ...
    {
        private readonly struct GraphicsCardBuildKitBuildResult
        {
            public GraphicsCardBuildKitBuildResult(
            ...
            public GraphicsCardBuildKitProjection Projection { get; }
        ...
        private static GraphicsCardBuildKitBuildResult
                ...
                Material labelPaper)
        {
            ...
            GameObject rearStop = CreateDetailCube(
                "GraphicsCardBuildKitRearStop",
                root,
                new Vector3(centerX, 1.036f, 4.243f),
                new Vector3(0.36f, 0.035f, 0.014f),
                accent);
            GameObject leftGuide = CreateDetailCube(
                "GraphicsCardBuildKitLeftGuide",
                root,
                new Vector3(centerX - 0.183f, 1.036f, 4.14f),
                new Vector3(0.012f, 0.035f, 0.20f),
                brushedSteel);
            GameObject rightGuide = CreateDetailCube(
                "GraphicsCardBuildKitRightGuide",
                root,
                new Vector3(centerX + 0.183f, 1.036f, 4.14f),
                new Vector3(0.012f, 0.035f, 0.20f),
                brushedSteel);
            GameObject identity = CreateBeveledCube(
                "GraphicsCardBuildKitIdentityCard",
                root,
                new Vector3(centerX, 1.085f, 3.86f),
                new Vector3(0.32f, 0.115f, 0.016f),
                0.006f,
                labelPaper,
                false);
            ...
            Transform snapAnchor = new GameObject(
                "GraphicsCardBuildKitSnapAnchor").transform;
            ...
            TextMesh progressText = new GameObject(
                "GraphicsCardBuildKitProgressText").AddComponent<TextMesh>();
            ...
            progressText.text = "BUILD KIT • 5/10\nGPU BEKLİYOR";
            progressText.gameObject.layer = ignoreRaycast;
            DisableDecorativeRendererCost(progressText.GetComponent<Renderer>());

            GraphicsCardBuildKitProjection projection =
                root.gameObject.AddComponent<GraphicsCardBuildKitProjection>();
            return new GraphicsCardBuildKitBuildResult(
                projection,
                surface,
                snapAnchor,
                progressText);
