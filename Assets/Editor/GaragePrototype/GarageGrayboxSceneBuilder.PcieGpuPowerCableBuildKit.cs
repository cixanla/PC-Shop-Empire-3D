...
namespace PCShopEmpire3D.Editor.GaragePrototype
{
    ...
    {
        private readonly struct PcieGpuPowerCableBuildKitBuildResult
        {
            public PcieGpuPowerCableBuildKitBuildResult(
            ...
            public PcieGpuPowerCableBuildKitProjection Projection { get; }
        ...
        private static PcieGpuPowerCableBuildKitBuildResult
                ...
                Material labelPaper)
        {
            ...
            Require(
                ...
                "PCIe GPU Build Kit tray requires support.");
            ...
            Transform snapAnchor = new GameObject(
                "PcieGpuPowerCableBuildKitSnapAnchor").transform;
            ...
            TextMesh progressText = new GameObject(
                "PcieGpuPowerCableBuildKitProgressText").AddComponent<TextMesh>();
            ...
            progressText.text = "BUILD KIT • 9/10\nPCIe GPU BEKLİYOR";
            progressText.gameObject.layer = ignoreRaycast;
            DisableDecorativeRendererCost(progressText.GetComponent<Renderer>());

            PcieGpuPowerCableBuildKitProjection projection =
                root.gameObject.AddComponent<PcieGpuPowerCableBuildKitProjection>();
            return new PcieGpuPowerCableBuildKitBuildResult(
                projection,
                surface,
                snapAnchor,
                progressText);
