...
namespace PCShopEmpire3D.Editor.GaragePrototype
{
    ...
    {
        private readonly struct PowerSupplyBuildKitBuildResult
        {
            public PowerSupplyBuildKitBuildResult(
            ...
            public PowerSupplyBuildKitProjection Projection { get; }
        ...
        private static PowerSupplyBuildKitBuildResult
                ...
                Material labelPaper)
        {
            ...
            Require(
                ...
                "Power-supply Build Kit tray requires support.");
            ...
            Transform snapAnchor = new GameObject(
                "PowerSupplyBuildKitSnapAnchor").transform;
            ...
            TextMesh progressText = new GameObject(
                "PowerSupplyBuildKitProgressText").AddComponent<TextMesh>();
            ...
            progressText.text = "BUILD KIT • 6/10\nPSU BEKLİYOR";
            progressText.gameObject.layer = ignoreRaycast;
            DisableDecorativeRendererCost(progressText.GetComponent<Renderer>());

            PowerSupplyBuildKitProjection projection =
                root.gameObject.AddComponent<PowerSupplyBuildKitProjection>();
            return new PowerSupplyBuildKitBuildResult(
                projection,
                surface,
                snapAnchor,
                progressText);
