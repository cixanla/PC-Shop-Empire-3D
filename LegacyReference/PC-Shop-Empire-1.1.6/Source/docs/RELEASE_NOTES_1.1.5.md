# PC Shop Empire 1.1.5 — Release Notes
...
1. Rebuilt main menu, general interface, and 1.1.5 visual identity
2. Three save slots and legacy save compatibility
3. Full-screen startup, F11 support, and main-menu Exit
4. Market stock/compatibility improvements and component resale
5. Staff morale, fatigue, specialization, and stronger staff effects
6. Detailed operating expenses, emergency financing, and corrected loan accounting
7. Operational incidents, configurable event frequency, and dynamic market conditions
8. Technical service, corporate tenders, marketing, and supplier systems
9. Business Intelligence, financial history, forecasting, and risk analysis
10. Daily objectives, achievements, and career progression
11. General, display, audio, gameplay, accessibility, controls, and data settings
12. Windows packaging metadata and macOS source preparation
...
- Settings tabs, full screen, and audio controls
...
3. Run the 1.1.5 Windows installer generated under `out\make`.
4. Open the **PC Shop Empire 1.1.5** shortcut.
5. Load the existing slot and verify money, day, inventory, and staff data.

The 1.1.5 compatibility layer recognizes the earlier save schema. Starting a new career is not required. If developing by manual merge, use the complete core files together with `src/`, `styles/`, and the current `assets/` content. Copying only `game.js` into an older folder will produce missing screens and inconsistent save behavior.
...
- `CHANGELOG.md`: version 1.1.5 change history
