...
## Stage B prototip görsel kayıtları
...
| Captive motherboard screw/cross recess, screwdriver ve fiziksel status plate | Unity primitive/ProBuilder geometri, built-in `TextMesh` ve proje içi mevcut URP materyalleri; deterministic scene builder | Issue #54 için özgün graybox sunumu; üçüncü taraf model, doku, font, marka, kod veya ücretli asset yok | 2026-08-15 |
