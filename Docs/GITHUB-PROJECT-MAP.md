...
| [#9](https://github.com/cixanla/PC-Shop-Empire-3D/issues/9) | [#46](https://github.com/cixanla/PC-Shop-Empire-3D/issues/46) — Deterministic customer visit ve bounded route fallback | Teknik kabul tamamlandı; `PSE.Actors`, monotonik visit/receipt ledger, iki denemeli route + patience/exit fallback, runtime NavMesh projection, authority izolasyonu, 255/255 EditMode, 18/18 PlayMode ve `runtime-route=ok fulfilled=ok`; Issue/Project kapanışı sürüyor |
