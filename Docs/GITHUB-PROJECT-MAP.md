...
| [#9](https://github.com/cixanla/PC-Shop-Empire-3D/issues/9) | [#48](https://github.com/cixanla/PC-Shop-Empire-3D/issues/48) — Stale-safe Buy action and checkout navigation | Kod/test/build/runtime tamamlandı; explicit binding, current revalidation, action-owned exact reservation, `Browsing → NavigatingToCheckout`, stale no-mutation; 287/287 EditMode, 19/19 PlayMode, `garage-buy-action-r17-v1 buy-action=ok stale-blocked=ok`; source/docs/USB/Done kapanışı yürütülüyor |
