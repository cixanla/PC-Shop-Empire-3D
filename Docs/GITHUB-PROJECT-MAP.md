...
Issue #52 ve parent Epic #9 kapalı/Roadmap `Done`dur. Sıradaki bounded geliştirme Epic #10 altında tek açık kasa/tek component/tek doğru slot ile ilk fiziksel PC assembly dilimidir; child issue henüz açılmamıştır.
