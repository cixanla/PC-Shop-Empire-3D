...
| [#10](https://github.com/cixanla/PC-Shop-Empire-3D/issues/10) | [#53](https://github.com/cixanla/PC-Shop-Empire-3D/issues/53) — Bounded motherboard seating and reversible physical assembly gate | Kaynak/test/build/runtime tamamlandı; `PSE.Assembly`, managed Workbench, stable serialized identity, attach/detach/replay/recovery, open chassis + keyed seat, gerçek keyboard/gamepad co-edge; 394/394 EditMode, 26/26 PlayMode, `garage-motherboard-seating-r22-v1 assembly-flow=ok ... recovery=ok`; feature `582a3cf`; remote CI/Issue metadata ve kullanıcı tarafından ertelenen USB snapshot takip checkpointinde |
