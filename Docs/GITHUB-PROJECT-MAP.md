...
| [#9](https://github.com/cixanla/PC-Shop-Empire-3D/issues/9) | [#47](https://github.com/cixanla/PC-Shop-Empire-3D/issues/47) — Explainable single-offer customer buy/leave decision | Feature tamamlandı; pure/equatable decision provenance, deterministic reason/failure, historical replay ve altı authority ailesinde no-mutation; 267/267 EditMode, 18/18 PlayMode, `garage-offer-decision-r16-v1 offer-decision=ok`; source/docs/USB kapanışı sürüyor |
