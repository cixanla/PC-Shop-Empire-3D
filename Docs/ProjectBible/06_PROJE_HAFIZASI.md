...
| D-151 | UVCS bağlantısı beklemeye alınır; mevcut Apple Git ile yerel `main` geçmişi geçici tek authoritative VCS olur. | Proje lideri kararı — uygulandı 11 Ağustos 2026 | UVCS'de workspace/changeset yoktur; Git root commit `b7ac8c36d9fb7be1eacf08b8f2b273d9c2574166`, tag `stage-a-baseline-2026-08-11`; remote/LFS yoktur ve büyük binary asset öncesi ayrı kapıdır. |
...
| R-024 | UVCS cloud dosya protokolünün mevcut ağ/rota/hizmet katmanında uzak uç tarafından sıfırlanması | UVCS tekrarları durduruldu; yerel Git tek authoritative geçmiş, USB hash snapshot off-device katmandır. Remote/LFS kararı büyük binary asset öncesi verilir. |
...
- Root commit `b7ac8c36d9fb7be1eacf08b8f2b273d9c2574166`; tag `stage-a-baseline-2026-08-11`; çalışma ağacı temiz, `git fsck --full` geçti, remote sayısı 0.
...
- Sıradaki küçük paket deterministik RNG sözleşmesidir; gameplay, asset veya uzun build henüz başlamadı.
