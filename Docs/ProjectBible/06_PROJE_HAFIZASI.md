...
- Okunaklı yarı gerçekçilik görsel yönü D-167/ADR-0013 ile kabul edildi. Sıradaki paket Issue #34 tek-köşe görsel benchmarktır; istifleme ve taşıma arabası ayrı acceptance paketleri, Inventory authority Issue #7/#8 bağımlılığıdır.
