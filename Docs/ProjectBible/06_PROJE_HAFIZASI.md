...
- Kapanış sınırı: fiziksel USB bağlı değildir; external milestone/readback iddiası yoktur. Issue #62 `OPEN`, Roadmap `In Progress` kalır. Source/docs + yerel staging tamamlanır; USB yeniden bağlandığında yalnız doğru volume üzerinde atomik final readback sonrası kapatılır.
