...
Paket ve Stage A kapsamı 11 Ağustos 2026'da onaylandı ve uygulandı. Stage B Core, oynanabilir GarageGraybox fiziksel akışı, görsel benchmark, Catalog + Inventory authority, atomik purchase-order receiving ve transactional dünya/stok projection'ı ayrı testli paketlerde kapatıldı. Güncel baseline Edit Mode 188/188 ve Play Mode 17/17'dir; sıradaki bounded iş fiziksel koli açma ve exact manifest birim projection'ıdır.
