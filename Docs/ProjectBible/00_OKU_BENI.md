...
- Otuz dokuzuncu bounded paket [Issue #62](https://github.com/cixanla/PC-Shop-Empire-3D/issues/62) olarak açıldı: tek canonical EPS12V/CPU 8-pin cable, iki typed/keyed endpoint, üç ordered waypoint, ayrı route identity/container/receipt/revision ve retained PSU + secured motherboard + retained CPU lineage'ında same-instance reversible routing. Electrical power-on, completed benchmark ve genel Inventory refactoru kapsam dışıdır.
