...
Stage A ve private GitHub güvenlik/devir temeli tamamlandı. Oynanabilir garaj; authoritative order-to-sale stok zinciri, deterministic customer visit, consultation-gated tek-offer `Buy/Leave` ve fiziksel checkout station üzerinden exact-cash Economy settlement'ını birlikte taşır. Issue #52 kanıtı 352/352 Edit Mode, 24/24 Play Mode, 327.864.494 bayt Universal macOS build, Apple M4/Metal 1280×720 stock r4/customer r6-r8 smoke ve doğrulanmış USB ile kapandı; marker `garage-physical-checkout-station-r21-v1`dir. Epic #9 kapalı/Done; sıradaki bounded geliştirme Epic #10 ilk fiziksel PC assembly dilimidir. Vergi/indirim, çoklu ürün/müşteri, Save ve Guardian ayrı kalır.
