...
**Belge durumu:** Onaylı araştırma/tasarım paketi 0.1 + uygulanmış Stage A ve Stage B authoritative motherboard-seating checkpoint'i 0.18<br>
...
Stage A ve private GitHub güvenlik/devir temeli tamamlandı. Oynanabilir garaj; authoritative order-to-sale stok zinciri, deterministic customer visit, consultation-gated tek-offer `Buy/Leave`, fiziksel checkout station üzerinden exact-cash Economy settlement ve ilk authoritative motherboard seating akışını birlikte taşır. Issue #53 feature `582a3cf`, 394/394 Edit Mode, 26/26 Play Mode, 328.020.817 bayt Universal macOS build ve Apple M4/Metal 1280×720 `garage-motherboard-seating-r22-v1` smoke ile doğrulandı. Remote/USB checkpointinden sonra Epic #10'da sıradaki bounded geliştirme yalnız motherboard fastener secure/unsecure dilimidir. Vergi/indirim, çoklu ürün/müşteri, CPU/RAM/GPU, Save ve Guardian ayrı kalır.
