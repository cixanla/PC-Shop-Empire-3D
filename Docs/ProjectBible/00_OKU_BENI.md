...
Stage A ve private GitHub güvenlik/devir temeli tamamlandı. Oynanabilir garajın fiziksel akışına ek olarak Catalog + Inventory ve atomik purchase-order receiving hazırdır: Edit Mode 184/184, Play Mode 14/14 geçti; son Universal Mac build/runtime smoke geçerlidir. Bir sonraki bounded iş `Arrived` manifestin görünür teslimat kutusu ve gerçek raf container'ıyla bağlantısıdır; fiziksel projection açık adaptör kurulana kadar authoritative stok değildir.
