...
- Technical commit `be04e66184abebff7c2d4ac3d0af8c63249a7f2e`, tree `4a6826cc1ecca1e97fd7df252cec10f1f39e1d3f`; full EditMode `722/722`, PlayMode `130/130`; Universal Mac report `330194031` bayt, Apple M1/Metal exact r48 smoke ve technical Guard `32955610423` başarılıdır.
- Complete bundle `7601437` bayt / `61ee0ea4…d5a` ile collision-free detached-clean Windows `issue95-be04e66-hardened-v1` x64 IL2CPP/only-D3D11 report `1343566575` bayt ve fatal-token `0` verdi. Intel Iris Xe Direct3D 11.0 level 11.1 exact r48 runtime host/readiness/success `1/1/1`, forbidden `0`, exit `0`, graceful shutdown, task deletion ve player/Unity/task residue `0` ile geçti.
