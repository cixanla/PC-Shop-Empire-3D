...
### Güncel checkpoint — Issue #91 r46 teknik/source-CI ve exact-head Mac/Windows native kapıları tamamlandı; source/docs, local/USB, insan ve idari kapanış sürüyor
