...
### Güncel checkpoint — Issue #89 r45 teknik/source-CI ve exact-head Mac/Windows native kapıları tamamlandı; source/docs, local/USB, insan ve idari kapanış sürüyor
