...
### Güncel checkpoint — Issue #99 exact `034f862` Mac/Windows/foreground OS-input kapıları tamamlandı; source/docs CI ve idari entegrasyon sürüyor
