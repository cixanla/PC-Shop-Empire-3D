...
### Güncel checkpoint — Issue #99 r50 teknik/source-docs CI, exact-head Mac/Windows native ve büyük local/sağlıklı USB kapıları tamamlandı; insan/idari kapanış sürüyor
...
- Full EditMode `733/733`, PlayMode `137/137`; failed/skipped/inconclusive `0`. Targeted Mac ve Windows kümeleri ayrı ayrı EditMode `5/5`, PlayMode `4/4` geçti. Universal Mac report `330251472` bayt, valid deep/strict universal executable ve Apple M1/Metal exact r50 readiness + GPU Assembly markerı başarılıdır.
- Technical Repository Guard `32990791761` ve `32990807874` exact source head üzerinde geçti. Exact bundle `7657509` bayt / `4afa8931…c74` ile detached-clean Windows x64 IL2CPP/only-D3D11 report `1350250674` bayt ve fatal-token `0` verdi. Intel Iris Xe/D3D11 exact r50 runtime; graceful exit, scheduled-task deletion ve exact player/Unity/build/task/validation-PowerShell residue `0` ile geçti.
- ADR-0059, tarihli Evidence ve `issue99` verifier contract'ı exact source/tests/Mac/Windows/binary/procedure kanıtını bağlar. Source/docs `0f259605da017e874863da2646eef6a90898816f` / tree `c0f5a07ac65baf959d4279d7a782a9827b369336` / Guard `32995195634` sonrasında canonical evidence exact `14/14`dır. Büyük immutable local final ve sağlıklı `Alu Line` USB incoming/final çift readback'leri aynı `1090/1090` payload, `1075/1075` Git source, `14/14` evidence, `20899041` bayt ve `0c2a26b5…5223` manifest sonucunu verdi; pre/post-write ExFAT health `0`, incoming/sidecar residue `0`dır. Exact-r50 insan oturumu beklediği için strict acceptance `30/31`; Issue #99 ve PR #100 açık/In Progress kalır.
