...
### Güncel checkpoint — Issue #105 r52 teknik accepted; PR #106 entegrasyonu sürüyor; Epic #10 ve Steam 1.0 Goal açık
...
- ADR-0061 ve tarihli Evidence exact kaynak/test/Mac/Windows/OS-input hashlerini bağlar. Claim `human=false`; fiziksel keyboard/gamepad/endurance Steam 1.0 sertifikasyonunda kalır. USB bulunmadı ve yazılmadı. PR #106 integration sonrasında Issue #105/Roadmap kapanır; Epic #10 ve ana Goal EPS12V/PCIe/electrical/product dilimleriyle sürer.
